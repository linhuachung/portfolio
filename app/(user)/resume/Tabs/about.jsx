...
function About() {
  ...
  return (
    <div className="flex flex-col gap-[30px]">
      <h3 className="text-4xl font-bold text-gray-900 dark:text-white">{ about.title }</h3>
      <p className="max-w-[600px] text-gray-700 dark:text-white/60 mx-auto xl:mx-0">{ about.description }</p>
