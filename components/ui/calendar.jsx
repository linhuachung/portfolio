...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={ cn(
        'bg-black dark:bg-black group/calendar p-3 [--cell-size:2rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent',
      ...
      classNames={ {
        ...
        dropdown_root: cn(
          'has-focus:border-slate-950 border-slate-200 shadow-xs has-focus:ring-slate-950/50 has-focus:ring-[3px] relative rounded-md border dark:has-focus:border-slate-300 dark:border-slate-800 dark:has-focus:ring-slate-300/50 pointer-events-auto cursor-pointer',
          defaultClassNames.dropdown_root
        ),
        dropdown: cn(
          'bg-white absolute inset-0 opacity-0 dark:bg-slate-950 pointer-events-auto',
