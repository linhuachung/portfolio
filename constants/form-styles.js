export const FORM_STYLES = {
  disabled: 'opacity-60 cursor-not-allowed text-gray-600 dark:text-gray-400',
  disabledReadonly: 'opacity-90 cursor-not-allowed',
  baseBorder: 'border-gray-400 dark:border-white/20',
  baseBg: 'bg-secondary-light dark:bg-secondary',
  errorBorder: '!border-red-600 dark:!border-red-500 [&]:!border-red-600 dark:[&]:!border-red-500',
  errorFocus: 'focus-visible:!border-red-600 dark:focus-visible:!border-red-500 focus-visible:ring-red-600 dark:focus-visible:ring-red-500 focus-visible:ring-1 !border-red-600 dark:!border-red-500 [&]:!border-red-600 dark:[&]:!border-red-500',
  errorFocusSelect: 'focus-visible:!border-red-600 dark:focus-visible:!border-red-500 focus-visible:ring-red-600 dark:focus-visible:ring-red-500 focus-visible:ring-1 data-[state=open]:!border-red-600 dark:data-[state=open]:!border-red-500 !border-red-600 dark:!border-red-500 [&]:!border-red-600 dark:[&]:!border-red-500',
