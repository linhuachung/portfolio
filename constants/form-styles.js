export const FORM_STYLES = {
  ...
  errorBorder: '!border-red-500 dark:!border-red-500 dark:border-red-500',
  errorFocus: 'focus-visible:!border-red-500 focus-visible:ring-red-500 focus-visible:ring-1 border-red-500',
  errorFocusSelect: 'focus-visible:!border-red-500 focus-visible:ring-red-500 focus-visible:ring-1 data-[state=open]:!border-red-500 border-red-500 dark:border-red-500 dark:data-[state=open]:!border-red-500',
