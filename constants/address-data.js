/**
 * Countries and cities data for address fields
 * All countries and cities are sorted alphabetically (A-Z)
 */
...
/**
 * Get cities list for a specific country
 * @param {string} country - Country value (e.g., 'vietnam', 'usa')
 * @returns {Array} Array of city objects with value and label properties
 */
